...
private:
    ...
    [[nodiscard]] static SourceLocation
        ...
        const auto upper =
            std::upper_bound(file.line_starts.begin(), file.line_starts.end(), clamped);
    ...
    [[nodiscard]] static std::string_view
        ...
        Offset end = line_number < file.line_starts.size() ? file.line_starts[line_number]
                                                           : file.text.size();
...
[[nodiscard]] inline std::string styled(
...
[[nodiscard]] inline std::string_view severity_name(Severity severity) {
    switch (severity) {
...
[[nodiscard]] inline cstc::ansi_color::Style severity_style(Severity severity) {
...
[[nodiscard]] inline cstc::ansi_color::Style gutter_style() {
    using cstc::ansi_color::Color;
    return {.foreground = Color::Blue, .bold = true};
}

[[nodiscard]] inline cstc::ansi_color::Style
...
[[nodiscard]] inline cstc::ansi_color::Style comment_style() {
    using cstc::ansi_color::Color;
    return {.foreground = Color::Blue, .bold = true};
}

[[nodiscard]] inline std::vector<SourceGroup> collect_source_groups(const Diagnostic& diagnostic) {
...
[[nodiscard]] inline std::size_t line_number_width(std::size_t line_number) {
    return std::to_string(line_number).size();
}

[[nodiscard]] inline std::pair<std::size_t, std::size_t> marker_columns(
...
[[nodiscard]] inline bool render_source_group(
