#ifndef CICEST_COMPILER_CSTC_LIR_PRINTER_IMPL_HPP
#define CICEST_COMPILER_CSTC_LIR_PRINTER_IMPL_HPP

/// @file printer_impl.hpp
/// @brief Inline implementation of the LIR human-readable formatter.
///
/// Included at the bottom of `printer.hpp`; not intended to be included directly.
...
#endif // CICEST_COMPILER_CSTC_LIR_PRINTER_IMPL_HPP
