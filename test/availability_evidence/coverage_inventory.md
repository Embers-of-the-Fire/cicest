...
| Symbolic function signatures | `availability_evidence/tyir/symbolic_function_availability.patterns`; `availability_evidence/tyir/ct_required_parameters.patterns` | Checks parameter/result signature summaries, CT-required parameters, runtime-result evidence, and call-site instantiation. |
